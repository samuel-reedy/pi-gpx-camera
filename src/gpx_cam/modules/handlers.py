...
from .classes.runtimeState import RuntimeState
...
class indexHandler(tornado.web.RequestHandler):
    def get(self):
        ...
        template_vars = {
            ...
            'isRecording': 'true' if RuntimeState.IS_RECORDING else 'false'
        }
...
class parametersHandler(tornado.web.RequestHandler):
    def get(self):
        ...
        msg = RuntimeState.MAV_MSG_GLOBAL_POSITION_INT
        ...
        template_vars = {
            ...
            'mav_satellites_visible': RuntimeState.MAV_SATELLITES_VISIBLE,
            'run_camera': RuntimeState.RUN_CAMERA,
            'is_recording': RuntimeState.IS_RECORDING,
            'rec_time': RuntimeState.REC_TIME
...
class StatusHandler(tornado.web.RequestHandler):
    ...
    def _get_latlon(self):
        msg = RuntimeState.MAV_MSG_GLOBAL_POSITION_INT
        if msg:
            n_satellites = RuntimeState.MAV_SATELLITES_VISIBLE
    ...
    def _get_record_state(self):
        return {"isRecording": RuntimeState.IS_RECORDING}
    ...
    def _get_record_time(Self):
        return {"rec_time": RuntimeState.REC_TIME}
...
class RecordHandler(tornado.web.RequestHandler):
    def post(self):
        ...
        if is_recording:
            ...
            RuntimeState.IS_RECORDING = True
            ...
            def capture_arr():
                ...
                while RuntimeState.IS_RECORDING:
                    ...
                    RuntimeState.REC_TIME = time.perf_counter() - begin_time
            ...
            def record(record_filename):
                fn_vid = f'../../data/recording/{record_filename}.avi' if RuntimeState.RUN_CAMERA else 'No Camera Found'
            ...
            RuntimeState.IS_RECORDING = False
            RuntimeState.REC_START_POSITION = None
